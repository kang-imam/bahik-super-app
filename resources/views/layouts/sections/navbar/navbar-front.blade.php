  ...
  <div class="container">
    <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
      ...
      <ul class="navbar-nav flex-row align-items-center ms-auto">
        ...
        <li>
          @if (Auth::check())
            <!-- Tombol untuk Dashboard jika sudah login -->
            <a href="{{ route('user-baru-dashboard') }}" class="btn btn-primary">
              <span class="icon-base ti tabler-dashboard scaleX-n1-rtl me-md-1"></span>
