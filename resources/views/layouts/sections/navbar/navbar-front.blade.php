            ...
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="nav-theme-text">
              <li>
                <button type="button" class="dropdown-item align-items-center active" data-bs-theme-value="light"
                  aria-pressed="false">
                  <span><i class="icon-base ti tabler-sun icon-md me-3" data-icon="sun"></i>Terang</span>
                </button>
              </li>
              <li>
                <button type="button" class="dropdown-item align-items-center" data-bs-theme-value="dark"
                  aria-pressed="true">
                  <span><i class="icon-base ti tabler-moon-stars icon-md me-3" data-icon="moon-stars"></i>Gelap</span>
                </button>
              </li>
              <li>
                <button type="button" class="dropdown-item align-items-center" data-bs-theme-value="system"
                  ...
                  <span><i class="icon-base ti tabler-device-desktop-analytics icon-md me-3"
                      data-icon="device-desktop-analytics"></i>Sistem</span>
                </button>
              </li>
            </ul>
          </li>
        ...
        <li>
          @if (Auth::check())
            <a href="{{ route('dashboard') }}" class="btn btn-primary">
              ...
              <span class="d-none d-md-block">Akses Pengguna</span>
            </a>
          @else
            <!-- Tombol Login jika belum login -->
            <a href="{{ Route::has('login') ? route('login') : url('auth/login-basic') }}" class="btn btn-primary">
              <span class="icon-base ti tabler-login scaleX-n1-rtl me-md-1"></span>
              <span class="d-none d-md-block">Masuk/Daftar</span>
            </a>
          @endif
        </li>
      </ul>
