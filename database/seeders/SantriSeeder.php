...
class SantriSeeder extends Seeder
{
  public function run(): void
  {
    ...
    $jenjang = JenjangPendidikan::pluck('id')->toArray();
    ...
    foreach ($namaPutra as $nama) {
      ...
      $santri = Santri::create([
        ...
        'tahun_masuk' => rand(2022, 2024), // Anda boleh ganti
        'jenis_kelamin_id' => $putra->id,
        'jenjang_pendidikan_id' => $jenjang[array_rand($jenjang)],
      ]);

      // Update user akses ke santri
      $user->update([
